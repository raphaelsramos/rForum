...
<?php
 ...
 ?>
	...
	<tr class="form-field" valign="top">
        ...
        <td>
			<details>
				<summary><?php _e( "Choose this forum's Moderators", 'r-forum' ) ?></summary>
<?php
...
?>
				<div class="moderator-item">
					<label><input type="checkbox" name="moderator[]" id="moderator_<?php echo $user->ID ?>" value="<?php echo $user->ID ?>"<?php if( in_array( $user->id, $moderator ) ) echo ' checked' ?> /> <span><?php echo $user->display_name ?> ( <?php echo count_user_comments( $user->ID ) .' '. __( 'comments', 'r-forum' ) ?> )</span><label>
				</div>
<?php
		}
	}
